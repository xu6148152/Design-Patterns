...
public final class DbManager {
    ...
    public static void updateDb(UserAccount userAccount) {
        ...
        db.getCollection("user_accounts")
          .updateOne(new Document("userID", userAccount.getUserId()), new Document("$set", new Document("userName", userAccount.getUserName()).append(
    ...
    public static void upsertDb(UserAccount userAccount) {
        ...
        db.getCollection("user_accounts")
          .updateOne(new Document("userID", userAccount.getUserId()), new Document("$set",
